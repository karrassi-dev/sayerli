...
type BadgeVariant =
  ...
  | 'clearance_en_cours' | 'rejetee_dgi'
...
const VARIANT_STYLES: Record<BadgeVariant, string> = {
  ...
  clearance_en_cours:  'bg-yellow-50 dark:bg-yellow-950/50 text-yellow-700 dark:text-yellow-400 border-yellow-200 dark:border-yellow-800',
  rejetee_dgi:         'bg-red-50 dark:bg-red-950/50 text-red-700 dark:text-red-400 border-red-300 dark:border-red-700',
...
const VARIANT_DOT: Partial<Record<BadgeVariant, string>> = {
  ...
  envoyee: 'bg-blue-500',
  clearance_en_cours: 'bg-yellow-500',
  rejetee_dgi: 'bg-red-600',
}
...
export function StatusBadge({ variant, label, dot, size = 'md' }: StatusBadgeProps) {
  ...
  const defaultLabels: Partial<Record<BadgeVariant, string>> = {
    ...
    clearance_en_cours: t('statuses.clearanceEnCours'),
    rejetee_dgi: t('statuses.rejeteeDGI'),
