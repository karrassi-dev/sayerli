    ...
    offers: [
      {
        ...
        description: 'Plan gratuit pour freelancers et petites entreprises au Maroc',
      ...
      },
      {
        ...
        priceCurrency: 'MAD',
        priceValidUntil: '2027-12-31',
        description: 'Plan Business pour équipes et agences au Maroc',
        url: `${SITE_URL}/register`,
      },
    ],
    featureList: [
      'CRM et gestion des clients',
      'Création de devis professionnels avec signature électronique',
      'Génération de factures conformes à la législation marocaine',
      'Bons de livraison (BL)',
      'Suivi des paiements en MAD',
      'Tableau de bord analytique et top clients',
      'Gestion multi-utilisateurs avec rôles (admin, manager, commercial, comptable)',
      'Portail client pour consultation des devis et factures',
      'Relances automatiques des factures en retard',
      'Journal des ventes et export Excel',
      'Catalogue de produits et services',
      'Reçu de paiement PDF',
      'Gestion des dépenses et reçus',
      'Notifications email et temps réel',
      'Accès cloud sécurisé',
      'Support en français, arabe et anglais',
      'Interface RTL pour l\'arabe',
      'Conformité DGI et facturation électronique Maroc',
    ],
...
export function FaqPageJsonLd() {
  const faqs = [
    ...
    },
    {
      ...
      a: 'Sayerli propose un plan gratuit (Starter) permettant de gérer jusqu\'à 5 clients, 5 devis et 5 factures par mois. Le plan Pro est à 199 MAD/mois avec plus de clients, devis et factures. Le plan Business est à 299 MAD/mois pour les équipes avec tout illimité.',
    },
    {
