...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Créez votre compte Sayerli gratuitement. Logiciel de devis, facturation et CRM pour PME marocaines. Aucune carte bancaire requise. Opérationnel en 5 minutes.',
  path: '/register',
  keywords: [
