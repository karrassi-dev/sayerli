...
export const PLAN_LIMITS: Record<PlanType, PlanLimits> = {
  ...
  PRO:      { clients: 20, devisParMois: 100, facturesParMois: 100, utilisateurs: 2, relancesParMois: -1, receiptsEmailsParMois: -1,  journalDesVentes: true  },
  BUSINESS: { clients: -1, devisParMois: -1,  facturesParMois: -1,  utilisateurs: 5, relancesParMois: -1, receiptsEmailsParMois: -1,  journalDesVentes: true  },
};
